...
in {
  imports =
    ...
    ++ lib.optional enableAgentSkills inputs.agent-skills-nix.homeManagerModules.default;
  ...
  xdg = lib.mkIf (!isDarwin) {
    ...
    dataFile."applications/slack.desktop" = {
      force = true;
      text = ''
        [Desktop Entry]
        Name=Slack
    ...
    dataFile."applications/mimeinfo.cache" = {
      force = true;
      text = ''
        [MIME Cache]
        x-scheme-handler/slack=slack.desktop;
